...
<script setup>
const props = defineProps(["addProduct"]);
const { addProduct } = toRefs(props);
...
const createProduct = () => {
  ...
  console.log(product.value.variants.length);
