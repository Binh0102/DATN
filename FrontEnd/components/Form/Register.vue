<template>
  <div class="top-0 right-0 left-0 bottom-0 w-full z-auto h-full">
    <div class="text-center pt-10 min-h-screen cursor-pointer" @click.self="closeAuth">
        ...
        <div class="w-1/2">
          <Transition name="slide-left" mode="out-in">
            <div
              v-if="isLogin"
              key="login"
              class="bg-[url('~/assets/images/bg-nike.jpg')] object-cover bg-no-repeat h-[555px] bg-cover text-white z-10"
