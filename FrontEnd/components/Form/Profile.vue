...
<template>
  <div>
    <div class="pt-10 min-h-screen cursor-pointer">
      <div class="w-[70%] bg-white mx-auto cursor-auto pb-6">
        <form>
          <div class="h-[575px] bg-cover relative">
            ...
            <div class="flex">
              <div class="w-9/12">
                ...
                <div class="ml-28 mt-8 flex">
                  ...
                  <input type="text" class="ml-6 w-[400px]" placeholder="Họ và tên" />
                </div>
                ...
                <div class="ml-28 mt-8 flex">
                  <p class="w-[110px]">Ngày sinh</p>
                  <input type="date" class="ml-6 w-[400px]" placeholder="Họ và tên" />
                </div>
            ...
            <div class="ml-28 mt-6 flex">
              <p class="w-[110px]"></p>
              <button class="ml-6 py-2 px-8 border bg-green-700 text-white">Lưu</button>
            </div>
          </div>
        </form>
      </div>
